 ...
 */
export function isValidEcsTaskStateChangeEvent(
  event: unknown
): event is EventBridgeEvent<'ECS Task State Change', EcsTaskDetail> {
 ...
 */
export function extractTaskMetrics(task: EcsTaskDetail): Record<string, unknown> {
